            ...
            <a href="/" className="tl-footer-logo">
              <div className="tl-footer-logo-icon">
                <svg width="44" height="44" viewBox="0 0 40 40">
                  <polygon points="20,2 38,11 38,29 20,38 2,29 2,11" fill="#4aa050" opacity=".15"/>
                  <polygon points="20,2 38,11 38,29 20,38 2,29 2,11" fill="none" stroke="#4aa050" strokeWidth="1.5"/>
                  <path d="M12 28 L12 18 L20 12 L28 18 L28 28" fill="none" stroke="#4aa050" strokeWidth="2" strokeLinejoin="round"/>
                  <line x1="12" y1="28" x2="28" y2="28" stroke="#4aa050" strokeWidth="2"/>
                </svg>
              </div>
              <div>
            ...
            <div className="tl-footer-contact">
              <a href={company.phoneHref} className="tl-footer-contact-item">
                <div className="tl-footer-contact-icon">
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#4aa050" strokeWidth="2">
                    <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81 19.79 19.79 0 01.006 1.22 2 2 0 012 .002h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/>
                  </svg>
                </div>
                {company.phone}
