      ...
      columns: [
        {
          ...
          items: [
            { name: "Holly Springs", link: "/service-areas/holly-springs" },
            { name: "Cary", link: "/service-areas/cary" },
            { name: "Chapel Hill", link: "/service-areas/chapel-hill" },
            { name: "Raleigh", link: "/service-areas/raleigh" },
            { name: "Durham", link: "/service-areas/durham" },
            { name: "Hillsborough", link: "/service-areas/hillsborough" },
            { name: "Orange County", link: "/service-areas/orange-county" },
          ],
        },
      ],
    },
