  ...
  return (
    <>
      ...
      <div className="cre-wrap">
                ...
                <li key={index} className="cre-link-item">
                  {item.hasDropdown ? (
                    <>
                      ...
                      {/* Mega menu — se cierra al salir del hover */}
                      <div
                      ...
                      >
                        ...
                        >
                          {item.columns.map((col, colIdx) => (
                            <div key={colIdx}>
                              {/* Título de columna — puede ser link o texto */}
                              {col.link
        ...
        {/* MOBILE MENU — también generado desde navItems */}
        ...
        <div className="cre-hero">
          ...
          <h1>Jackson's <br/><span className="orange">Most Complex Projects</span><br/>Demand More Than a Framer.</h1>
          <p>CRE Construction Group delivers integrated structural execution — framing, heavy timber, exterior systems, and precision finishes — for premium residential and resort projects across Teton County</p>
