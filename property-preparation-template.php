...
$img_hero = '/wp-content/uploads/2026/05/PropertyPreparationHouse-scaled.jpg';
?>
...
<style>
  ...
  .sv-header-sub { color: rgba(247, 250, 255,0.5); font-size: 16px; line-height: 1.75; max-width: 660px; margin: 0 auto 36px; text-shadow: 0 0 10px #27a139; }
  .sv-header-cta {
  ...
  .sv-realtor-section { padding: 88px 0; background: #FCF7EC; }
  .sv-realtor-inner {
  ...
  .sv-realtor-contact { display: flex; flex-direction: column; gap: 10px; padding-top: 8px; border-top: 1px solid rgba(42,90,73,0.15); }
  ...
  .sv-realtor-note {
    ...
    color: rgba(42,90,73,0.7); font-style: italic;
  }
...
$header_bg = '/wp-content/uploads/2026/05/PropertyPreparationHouse-scaled.jpg';
?>
    ...
    <div class="sv-container">
      <div class="sv-intro-grid">
        ...
        <div class="sv-reveal sv-intro-img-wrap">
          ...
          $img_hero = '/wp-content/uploads/2026/05/PropertyPreparationHouse-scaled.jpg';
          ?>
          <img src="<?php echo esc_url( $img_hero ); ?>" alt="TrueLine Property Preparation — NC property prep for sale" loading="lazy" />
        </div>
          ...
          <div class="sv-realtor-contact">
            <a href="tel:+19199518341" class="sv-realtor-contact-item">
              <div class="sv-realtor-contact-icon">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#2A5A49" stroke-width="2">
