    ...
    <div class="sv-container">
      ...
      $offerings = [
        [
          ...
          'desc' => 'Custom concrete and hardscape patios designed for your layout and lifestyle. From clean, modern slabs to structured outdoor living areas with seating and utility in mind.',
          'icon' => '<path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/><polyline points="9 22 9 12 15 12 15 22"/>',
        ],
        [
          'name' => 'Retaining Walls',
          'desc' => 'Structural retaining walls that manage elevation, control erosion, and define spaces — engineered for stability and built with precision.',
        ...
        [
          ...
          'desc' => 'Concrete or paver walkways that connect spaces, improve accessibility, and add a finished, intentional look to your property.',
          'icon' => '<circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/>',
        ],
        [
          'name' => 'Driveways & Parking Areas',
          'desc' => 'Durable concrete driveways and parking pads built for heavy use, proper drainage, and long-term performance.',
          'icon' => '<rect x="3" y="12" width="18" height="9" rx="1"/><path d="M3 12l4-7h10l4 7"/><line x1="3" y1="16" x2="21" y2="16"/>',
        ],
        [
          'name' => 'Concrete Work',
          'desc' => 'Custom concrete installations across residential and commercial properties — slabs, pads, borders, and more.',
          'icon' => '<path d="M12 2v6M8 6l4 4 4-4"/><circle cx="12" cy="17" r="5"/>',
        ],
        [
          'name' => 'Deck Installation',
          'desc' => 'New deck construction and repairs designed for safety, durability, and a clean aesthetic that complements your home.',
          'icon' => '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>',
        ],
        [
          'name' => 'Pergola Construction',
          'desc' => 'Freestanding or attached pergolas that extend your outdoor living space with structure, shade, and style.',
          'icon' => '<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>',
        ],
        [
          'name' => 'Fence Installation & Repair',
          'desc' => 'New fence installation and repair across a range of materials and styles — installed level, secure, and properly finished.',
  ...
  <section class="sv-who-section">
    <div class="sv-container">
      <div class="sv-who-inner sv-reveal">
        ...
        <p class="sv-who-body">
          We understand materials. We know what performs in North Carolina's climate — the temperature shifts, the rainfall, the soil conditions. That knowledge is built into every project we take on.
        </p>
        <p class="sv-who-body" style="margin-top:18px">
          We price fairly for the quality we deliver. We don't underbid and underperform. We show you what's needed, why it's needed, and what it will cost — clearly, before a single shovel hits the ground.
        </p>
      </div>
    </div>
  </section>
