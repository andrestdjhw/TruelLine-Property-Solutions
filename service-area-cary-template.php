<?php
/**
 * Template Name: Cary Service Area Template
 *
 * Página de área de servicio: Cary, NC.
...
<div class="sa-page">
  ...
  <div class="sa-header">
    ...
    <div class="sa-header-inner">
      <div class="sa-hero-label">
        ...
        TrueLine Property Solutions · Cary, NC
      </div>
      <h1>Serving<br><em>Cary, NC</em></h1>
      <p class="sa-header-sub">Professional landscaping, hardscape, drainage, tree services, exterior cleaning, and property preparation — delivered to Cary homeowners and properties at the standard they deserve.</p>
    ...
    <div class="sa-container">
      <div class="sa-intro-grid">
        ...
        <div class="sa-intro-text">
          <div class="sa-reveal">
            <span class="sa-label">Cary, NC</span>
            <h2 class="sa-title">Exterior Property Care<br>for <span>Cary</span></h2>
            <div class="sa-rule"></div>
          </div>
          <p class="sa-reveal sa-body" data-delay="1">
            Cary is consistently ranked among the best places to live in North Carolina — and its residents reflect that standard in how they maintain their homes and properties. <strong>Well-kept lawns, clean exteriors, and functional outdoor spaces</strong> are the norm here, not the exception.
          </p>
          <p class="sa-reveal sa-body" data-delay="2">
            TrueLine serves Cary with our full range of exterior services — <strong>landscaping, hardscape, drainage, tree services, exterior cleaning, and property preparation</strong> — delivered with the consistency and attention to detail that Cary homeowners expect.
          </p>
          <p class="sa-reveal sa-body" data-delay="3">
            We are <strong>licensed, insured, BBB accredited,</strong> and committed to delivering results you can see — from the first visit to the final walkthrough.
          </p>
        </div>
        ...
        <div class="sa-reveal sa-map-wrap">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d52003.44!2d-78.9218429!3d35.7890402!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89acbd54ff4a8b43%3A0x44568fdb5a444be1!2sCary%2C%20NC!5e0!3m2!1sen!2sus!4v1234567890"
            loading="lazy"
            referrerpolicy="no-referrer-when-downgrade"
            title="Cary, NC — TrueLine Property Solutions Service Area"
            allowfullscreen="">
          </iframe>
        </div>
  ...
  <section class="sa-services-section">
    <div class="sa-container">
      ...
      <div class="sa-services-head sa-reveal">
        <span class="sa-label">What We Do in Cary</span>
        <h2 class="sa-title">Services Available<br>in <span>Cary</span></h2>
      ...
      $services = [
        [
          'name' => 'Landscaping',
          'desc' => 'Design, installation, and maintenance for Cary properties — keeping established yards healthy and new builds looking sharp.',
        ...
        [
          ...
          'desc' => 'Patios, walkways, retaining walls, and driveways that add lasting value and function to your Cary property.',
        ...
        [
          ...
          'desc' => 'French drains and surface drainage solutions for Cary properties managing runoff, standing water, or slope erosion.',
        ...
        [
          'name' => 'Tree Services',
          'desc' => 'Trimming, removal, storm cleanup, and hazard management for the mature trees common across Cary\'s established neighborhoods.',
          'href' => '/services/tree-services',
          'icon' => '<path d="M12 22V12"/><path d="M5 12H2l10-10 10 10h-3"/><path d="M5 17H2l10-10 10 10h-3"/>',
        ],
        [
          'name' => 'Exterior Cleaning',
          'desc' => 'Pressure washing, roof cleaning, gutter maintenance, and surface care — keeping every exterior surface of your Cary home in top condition.',
        ...
        [
          ...
          'desc' => 'Full property prep for Cary homeowners, investors, and realtors — from curb appeal cleanup to complete pre-listing preparation.',
  ...
  <section class="sa-why-section">
    <div class="sa-why-inner">
      ...
      <div class="sa-reveal">
        ...
        <h2 class="sa-why-title">The Contractor Cary<br><span>Homeowners Can Count On</span></h2>
        <div class="sa-why-rule"></div>
        <p class="sa-why-body">
          Cary has a reputation for quality — and the homeowners here have high standards for the contractors they invite onto their properties. <strong>TrueLine meets that standard on every visit.</strong>
        </p>
        <p class="sa-why-body" style="margin-top:16px">
          We communicate clearly, show up prepared, use quality materials, and don't leave a job until it's done right. <strong>That's not the exception for us — it's the baseline.</strong>
        </p>
      </div>
      ...
      <div class="sa-why-items">
        ...
        $reasons = [
          [
            'title' => 'Serving Cary & Surrounding Areas',
            'desc'  => 'We work throughout Cary and the surrounding Triangle — familiar with the neighborhoods, the properties, and the expectations.',
            'icon'  => '<path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/>',
          ],
          [
            'title' => 'Licensed & Fully Insured',
            'desc'  => 'All required North Carolina registrations current. Full liability and workers\' comp coverage on every job.',
            'icon'  => '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>',
          ],
          [
            'title' => 'Free, Detailed Estimates',
            'desc'  => 'We walk your property, scope the work honestly, and give you a clear number before any work begins.',
          ...
          [
            ...
            'desc'  => 'Recognized for honest, transparent business practices and consistent customer satisfaction.',
  ...
  <div class="sa-nearby-section sa-reveal">
    <div class="sa-nearby-inner">
      ...
      <nav class="sa-nearby-list" aria-label="Nearby service areas">
        <?php
        $nearby = [ 'Holly Springs', 'Chapel Hill', 'Raleigh', 'Durham', 'Hillsborough', 'Orange County' ];
  ...
  <section class="sa-cta-section">
    <div class="sa-cta-inner sa-reveal">
      <span class="sa-cta-label">Cary, NC</span>
