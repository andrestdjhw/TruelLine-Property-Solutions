...
<style>
  ...
  /* ── BASE ── */
  .ct-page { font-family: 'Barlow', sans-serif; background: #FCF7EC; color: #091914; }
  .ct-page {
    --accent:        #2A5A49;
  ...
  /* Wave */
  .ct-wave { line-height: 0; background: linear-gradient(160deg, #091914, #133429); }
  ...
  .ct-info-card {
    ...
    box-shadow: 0 2px 16px rgba(9,25,20,0.08); border-top: 3px solid var(--accent);
    transition: transform 0.25s, box-shadow 0.25s;
  }
  .ct-info-card:hover { transform: translateY(-4px); box-shadow: 0 10px 32px rgba(9,25,20,0.13); }
  .ct-info-icon {
  ...
  .ct-info-sub { font-size: 12px; color: rgba(9,25,20,0.4); line-height: 1.5; }
  ...
  .ct-side-card {
    ...
    box-shadow: 0 2px 16px rgba(9,25,20,0.08);
  }
  .ct-side-title {
  ...
  .ct-hours-row {
    ...
    padding: 9px 0; border-bottom: 1px solid rgba(42,90,73,0.08); font-size: 13.5px;
  }
  ...
  .ct-area-tag:hover { background: rgba(42,90,73,0.15); }

  /* ══ MAP ══ */
  .ct-map-section { margin-top: 72px; }
  .ct-map-head { margin-bottom: 28px; }
  .ct-map-wrap { border-radius: 8px; overflow: hidden; box-shadow: 0 4px 30px rgba(9,25,20,0.12); }
  ...
  .ct-faq-item {
    ...
    box-shadow: 0 1px 12px rgba(9,25,20,0.07);
  ...
  .ct-faq-item.open .ct-faq-icon { background: rgba(42,90,73,0.18); transform: rotate(45deg); }
  .ct-faq-body {
            ...
            <div class="ct-faq-item ct-reveal" data-delay="<?php echo ( $i % 4 ) + 1; ?>" data-index="<?php echo $i; ?>">
              <button class="ct-faq-btn" onclick="ctToggleFaq(this)">
                ...
                <div class="ct-faq-icon">
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#2A5A49" stroke-width="2.5">
