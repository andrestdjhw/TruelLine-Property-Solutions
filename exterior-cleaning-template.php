<?php
/**
 * Template Name: Exterior Cleaning Template
 *
 * Página de servicio: Exterior Cleaning.
...
// DEV NOTE: Replace with real before/after photo — pressure-washed driveway or clean roofline, high visual impact
$img_hero = $theme_uri . '/assets/images/exterior-cleaning-hero.jpg';
?>
...
<div class="sv-page">
  ...
  <div class="sv-header">
    ...
    <div class="sv-header-inner">
      <div class="sv-hero-label">
        ...
        TrueLine Property Solutions · Exterior Cleaning
      </div>
      <h1>Exterior Cleaning<br><em>Services</em></h1>
      <p class="sv-header-sub">Roof cleaning, gutter maintenance, pressure washing, and surface care — protecting every exterior surface of your property and keeping it looking sharp.</p>
    ...
    <div class="sv-container">
      <div class="sv-intro-grid">
        ...
        <div class="sv-reveal sv-intro-img-wrap">
          <?php if ( file_exists( get_template_directory() . '/assets/images/exterior-cleaning-hero.jpg' ) ) : ?>
            <img src="<?php echo esc_url( $img_hero ); ?>" alt="TrueLine Exterior Cleaning — pressure washing NC" loading="lazy" />
          <?php else : ?>
            <div class="sv-intro-img-placeholder">
              ...
              <!-- DEV NOTE: Add before/after pressure wash or clean roofline photo at /assets/images/exterior-cleaning-hero.jpg -->
        ...
        <div class="sv-intro-text">
          <div class="sv-reveal">
            ...
            <h2 class="sv-title">Protect What's<br><span>on the Outside</span></h2>
            <div class="sv-rule"></div>
          </div>
          <p class="sv-reveal sv-body" data-delay="1">
            Your home's exterior is constantly exposed to weather, debris, algae, and wear. Left unattended, surfaces degrade faster — <strong>costing you more in repairs and reducing the curb appeal that drives property value.</strong>
          </p>
          <p class="sv-reveal sv-body" data-delay="2">
            TrueLine's cleaning services are designed to maintain every exterior surface of your property with <strong>precision, the right equipment, and the right techniques for each material.</strong>
          </p>
        </div>
    ...
    <div class="sv-container">
      ...
      $offerings = [
        [
          ...
          'desc' => 'High-performance pressure washing for driveways, walkways, patios, fences, siding, and exterior surfaces — removing buildup, stains, and years of grime without damaging what\'s underneath.',
        ...
        [
          'name' => 'Roof Cleaning',
          'desc' => 'Safe, low-pressure roof cleaning that removes algae, moss, lichen, and debris — extending the life of your roofing material and restoring your home\'s appearance.',
        ...
        [
          ...
          'desc' => 'Full gutter cleaning, inspection, and debris removal to prevent clogs, overflow, and the water damage they cause to fascia, siding, and foundation.',
          'icon' => '<path d="M12 2v6M8 6l4 4 4-4"/><path d="M3 14s1-1 2-1 2 2 3 2 2-2 3-2 2 2 3 2 2-1 2-1"/>',
        ],
        [
          'name' => 'Deck & Surface Washing',
          'desc' => 'Careful cleaning of wood, composite, and concrete deck surfaces — removing mildew, stains, and buildup while preserving the integrity of the material.',
  ...
  <section class="sv-who-section">
    <div class="sv-container">
      <div class="sv-who-inner sv-reveal">
        ...
        <p class="sv-who-body">
          Not every surface should be treated the same way. We <strong>assess each material before we apply any pressure or product</strong> — ensuring your roof, siding, or patio is cleaned effectively without damage.
        </p>
        <p class="sv-who-body" style="margin-top:18px">
          That's not standard practice in this industry. <strong>For us, it's the baseline.</strong>
        </p>
      </div>
    </div>
  </section>
  ...
  <div class="sv-areas-section sv-reveal">
    <div class="sv-areas-inner">
      ...
      <nav class="sv-areas-list" aria-label="Exterior cleaning service areas">
        <?php
